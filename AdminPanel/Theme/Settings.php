...
//////// Type page's scripts
global $ScriptArr;
$ScriptArr = array('Libraries/jquery-1.11.1.min.js', 'Libraries/W3Data.js', 'Libraries/ViewModel.js', 'Libraries/ckeditor.js', 'Libraries/anytime.js');
global $ScriptByPageArr;
$ScriptByPageArr = array(
    'home' => array('Scripts/home.js'),
    'panel' => array('Scripts/panel.js'),
    'forms' => array('Scripts/forms.js')
);

//////// Type mod's pages
function VerifyPageContent($page){
    $array = array(
        'WebSite' => array('home', 'panel', '404', 'forms')
    );
    if(isset($page)){
